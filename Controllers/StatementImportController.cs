...
public partial class StatementImportController(BankDbContext db) : ControllerBase
{
    ...
    private static string GuessCategory(string description, BudgetEntryType type)
    {
        ...
        var expenseCategory = BestCategory(text,
            ...
            ("Yemek / Kafe", new[] { "kafe", "cafe", "restoran", "restaurant", "lokanta", "yemek", "ogle yemegi", "aksam yemegi", "kahvalti", "menu", "fastfood", "kahve", "pizza", "burger", "kebap", "doner", "dondurma", "nido", "mcdonalds", "burgerking", "kfc", "dominos", "getir", "yemeksepeti", "starbucks", "kahvedunyasi", "bigchefs", "simit", "pastane", "firin", "kasap", "kasap alisverisi", "etvetavuk", "balik", "cigkofte" }),
            ...
            ("Araç Yıkama", new[] { "aracyikama", "otoyikama", "oto kuafor", "arackuaforu", "carwash", "yikamacilik" }),
            ...
            ("Eğlence", new[] { "sinema", "film", "tiyatro", "konser", "eglence", "bowling", "lunapark", "festival", "etkinlik", "eglenceparki", "oyun", "playstation", "xbox", "steam" }),
