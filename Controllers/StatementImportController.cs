...
public partial class StatementImportController(BankDbContext db) : ControllerBase
{
    ...
    private static string GuessCategory(string description, BudgetEntryType type)
    {
        ...
        if (text.Contains("metro") || text.Contains("otobus") || text.Contains("taksi") || text.Contains("akaryakit") || text.Contains("petrol") || text.Contains("shell") || text.Contains("ispark") || text.Contains("otopark") || text.Contains("uber")) return "Ulaşım";
