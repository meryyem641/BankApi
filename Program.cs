...
using (var scope = app.Services.CreateScope())
{
    ...
    var defaultCategories = new[]
    {
        ...
        ("Ulaşım", BudgetEntryType.Expense), ("Araç Yıkama", BudgetEntryType.Expense), ("Giyim", BudgetEntryType.Expense), ("Abonelik", BudgetEntryType.Expense),
        ("Eğlence", BudgetEntryType.Expense),
